...
export default {
    ...
    data() {
        return {
            ratingselectSelectType: this.selectType,
            ratingselectOnlyContent: this.onlyContent
        };
    },
    watch: {
        selectType: function() {
            this.ratingselectSelectType = this.selectType;
        },
        onlyContent: function() {
            this.ratingselectOnlyContent = this.onlyContent;
        }
    },
    methods: {
        select(type, event) {
            ...
            this.ratingselectSelectType = type;
        ...
        toggleContent(event) {
            ...
            this.ratingselectOnlyContent = !this.ratingselectOnlyContent;
            this.$emit('toggle');
        }
    },
    computed: {
